        ...
        <DelayedVisibility>
          <MotionTransition1 position="top">
            <div className="text-center max-w-5xl gap-6 mx-auto ">
              ...
              <p className="container mx-auto mb-3 text-xl text-slate-300 md:text-2xl py-10">
                I have a range of skills to help you achieve your goals.
                Whether you need assistance with web development, design, or other skills, I am here to help to achieve your goals.
              </p>
              <div>
                <SlideServices />
              </div>
